...
function upDate(previewPic){document.getElementById('image').style.backgroundImage = "url('"+previewPic.src+"')";document.getElementById('image').innerHTML =previewPic.alt;}
 /* In this function you should 
    ...
    */
function pickImage(){button="click to get awesome picture";options=["fort_in_woods.png","istockphoto-1419410282-612x612.jpg","pexels-pixabay-158063.jpg","colourful.jpg","high_altitude_aerial_view_above_cotton_soft_cloud_tops_glowing_in_golden_hour_light-full.jpg","pexels-alena-koval-233944-886521.jpg"]
