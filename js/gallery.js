...
currentImages[i].src=randomImg;currentImages[i].src=randomImg;currentImages[i].setAttribute("tabindex","0");document.getElementById('image').innerHTML =previewPic.alt;}}
